...
/**
 * Using MockitoJUnitRunner all the objects annotated with @Mock will be created without the need
...
class CharactersViewModelTest {
    ...
    /**
     *  The test's main object should not be mocked, only its dependencies.
     */
